...
const ITENS: ItemMenu[] = [
  ...
  { href: '/chumbo/contagem', titulo: 'Chumbo — Contagem', descricao: 'Contagem diária e revisão contra o sistema', cor: 'var(--laranja)', icone: 'M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z', pronto: true },
  { href: '/dashboard', titulo: 'Dashboard', descricao: 'Métricas, gráficos e indicadores do chumbo', cor: 'var(--teal)', icone: 'M4 19h16M4 19V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v14M10 11h4a1 1 0 0 1 1 1v7M19 8v11', pronto: true },
  { href: '/relatorios', titulo: 'Relatórios', descricao: 'Movimentações, saldos e divergências (XLSX/PDF)', cor: 'var(--roxo)', icone: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M8 13h8M8 17h8', pronto: true },
...
const FUTUROS: { titulo: string; descricao: string }[] = [];
